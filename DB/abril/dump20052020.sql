...
-- Started on 2020-05-20 11:29:15 CDT
...
159	2	2020-05-19	0	0	20:16:48.718782-05
...
3	3	3	Editorial	editorial	123	1
...
SELECT pg_catalog.setval('public.id_historial_seq', 179, true);
...
--
-- TOC entry 2866 (class 2606 OID 441633)
-- Name: edi_sellos fk_sellos_edi_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.edi_sellos
    ADD CONSTRAINT fk_sellos_edi_id FOREIGN KEY (edi_id) REFERENCES public.editoriales(id) NOT VALID;
...
-- Completed on 2020-05-20 11:29:16 CDT
