...
-- Started on 2021-03-04 09:15:06 CST
...
15	Rogelio	Ilustador	Afganistán
\.
...
COPY public.libros (edi_id, titulo, titulo_original, material, indice_titulo, material_lengua_indigena, sello_id, edicion, anio, tiraje, resenia, isbn, paginas_con_folio, pais, ciudad, reconocimiento_libro, reconocimiento_autor, reconocimiento_ilustrador, nivel, genero, categoria, precio_publico, disponibilidad, numero_tipo_papel, id, fecha_creacion, antologia, ilustrado, formato, ancho, alto, paginas_totales, paginas_preliminares, paginas_finales, lomo) FROM stdin;
1111	Título libro	ddd		abc	Pa-Ipai	168	Edición del título	1584	56	def	1266-adf15-55	55	Albania	Ciudad	def	ghi	jkl	1pre	Texto literario	El cuerpo	1585	50	2	8	2021-02-24	1	0	horizontal	50	100	150	235	86	85
1111	Título libro 2			asdf	Cucapá	169	Edición del título	55	55	dsf	fsd-465-fs	565	Afganistán	dfs	fds	d	d	1pre	Texto literario	El cuerpo	555	5	2	9	2021-02-24	0	1	horizontal	55	55	55	55	55	55
\.
...
SELECT pg_catalog.setval('public.id_historial_seq', 487, true);
...
SELECT pg_catalog.setval('public.libros_id_seq', 9, true);
...
-- Completed on 2021-03-04 09:15:07 CST
