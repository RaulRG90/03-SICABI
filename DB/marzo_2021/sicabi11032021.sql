...
-- Started on 2021-03-11 05:19:47 CST
...
-- Name: cat_paises; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.lib_autores (
    ...
    aut_pais character varying NOT NULL
);
...
-- Name: lib_autores_aut_id_seq1; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.lib_autores_aut_id_seq1
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.lib_autores_aut_id_seq1 OWNER TO postgres;

--
-- TOC entry 3091 (class 0 OID 0)
-- Dependencies: 214
-- Name: lib_autores_aut_id_seq1; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.lib_autores_aut_id_seq1 OWNED BY public.lib_autores.aut_id;
...
CREATE TABLE public.libros (
    ...
    indice_titulo character varying,
    material_lengua_indigena character varying,
    sello_id integer,
    edicion character varying NOT NULL,
    anio integer NOT NULL,
    tiraje integer NOT NULL,
    resenia character varying NOT NULL,
    isbn character varying NOT NULL,
    paginas_con_folio character varying NOT NULL,
    pais character varying NOT NULL,
    ciudad character varying NOT NULL,
    reconocimiento_libro character varying,
    reconocimiento_autor character varying,
    reconocimiento_ilustrador character varying,
    nivel character varying NOT NULL,
    genero character varying NOT NULL,
    categoria character varying NOT NULL,
    precio_publico integer NOT NULL,
    disponibilidad integer NOT NULL,
    numero_tipo_papel integer NOT NULL,
    id integer NOT NULL,
    fecha_creacion date DEFAULT now() NOT NULL,
    antologia smallint DEFAULT 0,
    ilustrado smallint DEFAULT 0,
    formato character varying DEFAULT 'vertical'::character varying NOT NULL,
    ancho integer DEFAULT 0 NOT NULL,
    alto integer DEFAULT 0 NOT NULL,
    paginas_totales integer DEFAULT 0 NOT NULL,
    paginas_preliminares integer DEFAULT 0 NOT NULL,
    paginas_finales integer DEFAULT 0 NOT NULL,
    lomo integer DEFAULT 0 NOT NULL,
    forro character varying NOT NULL,
    solapa character varying,
    papel_forro_1 character varying NOT NULL,
    gramaje_forro_1 character varying NOT NULL,
    tinta_forro character varying NOT NULL,
    acabado_forro character varying,
    suaje_forro character varying,
    grabado_forro character varying,
    foliacion character varying,
    papel_guardas_1 character varying,
    tinta_guardas character varying,
    num_paginas_interior_1 integer NOT NULL,
    papel_forro_2 character varying NOT NULL,
    gramaje_forro_2 character varying NOT NULL,
    papel_guardas_2 character varying,
    papel_interior_1_1 character varying NOT NULL,
    papel_interior_1_2 character varying NOT NULL,
    gramaje_interior_1_1 integer NOT NULL,
    gramaje_interior_1_2 character varying NOT NULL,
    tinta_interior_1 character varying NOT NULL,
    acabados_interior_1 character varying NOT NULL,
    suaje_interior_1 character varying,
    grabado_interior_1 character varying,
    num_paginas_interior_2 integer NOT NULL,
    papel_interior_2_1 character varying NOT NULL,
    papel_interior_2_2 character varying NOT NULL,
    gramaje_interior_2_1 integer NOT NULL,
    gramaje_interior_2_2 character varying NOT NULL,
    tinta_interior_2 character varying NOT NULL,
    acabados_interior_2 character varying NOT NULL,
    suaje_interior_2 character varying,
    grabado_interior_2 character varying,
    paginas_desplegables integer,
    encartes integer,
    pop_ups character varying,
    disco_compacto integer,
    audiocinta integer,
    videocinta integer,
    otras_caracteristicas_especiales character varying,
...
--
-- TOC entry 2843 (class 2604 OID 16520)
...
--
-- TOC entry 2844 (class 2604 OID 16521)
...
--
-- TOC entry 2845 (class 2604 OID 16522)
...
--
-- TOC entry 2847 (class 2604 OID 16523)
...
--
-- TOC entry 2850 (class 2604 OID 16524)
...
--
-- TOC entry 2851 (class 2604 OID 16525)
...
--
-- TOC entry 2852 (class 2604 OID 16526)
-- Name: lib_autores aut_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lib_autores ALTER COLUMN aut_id SET DEFAULT nextval('public.lib_autores_aut_id_seq1'::regclass);


--
-- TOC entry 2863 (class 2604 OID 16527)
...
--
-- TOC entry 2864 (class 2604 OID 16528)
...
--
-- TOC entry 2865 (class 2604 OID 16529)
...
--
-- TOC entry 2866 (class 2604 OID 16530)
...
--
-- TOC entry 3048 (class 0 OID 16385)
-- Dependencies: 196
...
--
-- TOC entry 3049 (class 0 OID 16389)
-- Dependencies: 197
...
--
-- TOC entry 3051 (class 0 OID 16397)
-- Dependencies: 199
...
--
-- TOC entry 3052 (class 0 OID 16403)
-- Dependencies: 200
...
1	Convocatoria	convocatoria	2020-04-30	2021-12-01	\N
2	Acreditación de Editoriales	acreditacion	2020-05-01	2022-02-28	\N
3	Registro de Títulos	registro_titulos	2020-05-01	2021-05-31	\N
...
-- Dependencies: 202
-- Data for Name: cat_paises; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3055 (class 0 OID 16418)
-- Dependencies: 203
...
--
-- TOC entry 3056 (class 0 OID 16424)
-- Dependencies: 204
...
168	1111	sello 1	2020-12-24
169	1111	sello 2	2020-12-24
170	1111	sello 3	2020-12-24
171	1112	w	2021-02-25
172	1112	sello 2	2021-02-25
173	1112	w3	2021-02-25
\.
...
COPY public.editoriales (id, usu_id, edi_razonsocial, edi_grupoedit, edi_dirgeneral, edi_dirmail, edi_dircel, edi_repnombre, edi_repcargo, edi_repemail, edi_observaciones, fecha_creacion, edi_activo, edi_rfc, edi_colonia, edi_calle, edi_numero, edi_cp, edi_pais, edi_entidad_federativa, edi_delegacion, edi_telefonos, edi_email, acreditador, edi_ciudad) FROM stdin;
1111	1111	La casa del libro S.A. de C.V.	La casa del libro	José de Jesus	jesusfuentesgalindo@gmail.com	55555555	José Perez	Representante	jesusfuentesgalindo@gmail.com	ddd	2020-12-24	t	FD456REDPIS	Colonia	Calle	10	52966	México	Ciudad de México	Iztapalapa	55555	jesusfuentesgalindo@gmail.com	210	Méx.
1112	1112	editorial S.A.	Tecolote	director	email@mail.com	55555555	Gustavo Retana Gervacio	Representante	elrepre@mail.com	palabras	2021-02-25	t	FD456REDPfd	Colonia	Calle	10	52966	México	Puebla	Amozoc	55555	jesusfuentesgalindo@gmail.com	210	Atizapán de Zaragoza
\.


--
-- TOC entry 3060 (class 0 OID 16441)
-- Dependencies: 208
...
415	210	2020-12-24			13:55:52.304024-06
416	1	2020-12-24			14:01:36.036026-06
417	210	2020-12-24			14:03:09.983829-06
418	210	2020-12-24			14:20:30.841976-06
419	1	2020-12-24			15:02:44.248006-06
420	210	2020-12-24			15:08:40.238508-06
421	1	2020-12-24			15:11:11.90844-06
422	210	2020-12-24			15:12:36.050405-06
423	1	2020-12-24			15:14:02.148183-06
424	210	2020-12-24			15:39:08.997033-06
425	1	2020-12-24			15:44:37.056093-06
426	210	2020-12-24			15:45:00.051065-06
427	1	2020-12-24			16:19:18.72828-06
428	210	2020-12-24			16:24:57.108769-06
429	1	2020-12-24			16:48:43.878503-06
430	210	2020-12-24			16:49:42.378234-06
431	1	2020-12-24			16:57:00.129265-06
432	210	2020-12-24			17:45:23.952688-06
433	1	2020-12-24			18:21:08.850333-06
434	210	2020-12-24			18:27:59.154116-06
435	210	2020-12-24			18:29:29.457948-06
436	1	2020-12-24			18:29:41.45064-06
437	1	2021-01-20			01:22:11.447126-06
439	210	2021-01-20			01:38:32.495304-06
440	1	2021-01-20			01:38:55.239053-06
441	210	2021-01-20			01:39:37.481205-06
444	210	2021-01-21			16:47:23.801879-06
446	1	2021-01-21			18:09:44.784526-06
448	1	2021-01-21			23:58:18.303837-06
449	1111	2021-01-22			00:00:07.696132-06
450	1111	2021-01-29			01:44:43.800403-06
451	1111	2021-02-11			04:43:06.093353-06
452	1	2021-02-11			04:45:52.741796-06
453	1	2021-02-13			21:20:10.520696-06
454	1111	2021-02-13			21:26:37.175734-06
455	1111	2021-02-13			23:44:42.181501-06
456	1111	2021-02-13			23:52:18.988568-06
457	1111	2021-02-14			00:04:47.128974-06
458	1	2021-02-14			00:07:36.395579-06
459	1111	2021-02-14			00:32:08.343727-06
460	1	2021-02-14			00:32:49.283048-06
461	1111	2021-02-14			00:34:48.678935-06
462	1111	2021-02-15			17:47:12.830854-06
463	1111	2021-02-15			23:37:23.288686-06
464	1111	2021-02-16			00:24:26.879561-06
465	1111	2021-02-16			19:33:47.520486-06
466	1111	2021-02-16			22:40:47.466293-06
467	1111	2021-02-18			02:52:31.689078-06
468	1111	2021-02-18			02:53:19.969326-06
469	1111	2021-02-18			16:12:52.841098-06
470	210	2021-02-18			17:13:19.107039-06
471	1111	2021-02-18			17:16:47.89556-06
472	1111	2021-02-18			23:50:16.90623-06
473	1	2021-02-19			00:02:45.782138-06
474	1111	2021-02-19			00:32:44.167974-06
475	1	2021-02-19			02:42:12.686132-06
476	1111	2021-02-19			02:45:01.478722-06
477	1111	2021-02-23			21:03:05.731833-06
478	1111	2021-02-24			13:31:17.149911-06
479	210	2021-02-25			00:36:12.104665-06
480	1	2021-02-25			00:38:27.442643-06
481	1112	2021-02-25			00:39:33.967604-06
482	1	2021-02-28			06:36:44.042404-06
483	1112	2021-02-28			06:37:37.842638-06
484	1	2021-02-28			21:36:26.397178-06
485	1	2021-03-01			00:01:33.84866-06
486	1112	2021-03-01			01:49:59.523656-06
487	1	2021-03-04			09:10:23.658368-06
488	1112	2021-03-07			19:27:21.157264-06
489	1112	2021-03-10			23:46:22.609063-06
490	1112	2021-03-11			00:02:39.363173-06
\.
...
10	Convocatoria	3	fecha_fin_acceso	guardar_fechas_modulos	2021-01-20	2020-05-22	2021-04-30	1
11	Convocatoria	2	fecha_fin_acceso	guardar_fechas_modulos	2021-01-20	2020-12-31	2022-02-28	1
12	Convocatoria	3	fecha_fin_acceso	guardar_fechas_modulos	2021-02-28	2021-04-30	2021-05-31	1
\.


--
-- TOC entry 3065 (class 0 OID 16461)
-- Dependencies: 213
-- Data for Name: lib_autores; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.lib_autores (aut_id, aut_nombre, aut_tipo, aut_pais) FROM stdin;
14	José Fuentes	Autor	Afganistán
\.
...
9	editorial/registro_titulos/datos_editorial	15	Datos de Editorial
8	editorial/registro_titulos/formulario_registro	15	Registro de Títulos
11	administrador/registro_titulos/reportes_titulos	7	Reportes de Títulos
10	administrador/registro_titulos/gestion_editoriales	7	Gestión de Editoriales
12	administrador/registro_titulos/titulos_registrados	7	Registro de Títulos
\.


--
-- TOC entry 3068 (class 0 OID 16475)
-- Dependencies: 216
-- Data for Name: libros; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.libros (edi_id, titulo, titulo_original, material, indice_titulo, material_lengua_indigena, sello_id, edicion, anio, tiraje, resenia, isbn, paginas_con_folio, pais, ciudad, reconocimiento_libro, reconocimiento_autor, reconocimiento_ilustrador, nivel, genero, categoria, precio_publico, disponibilidad, numero_tipo_papel, id, fecha_creacion, antologia, ilustrado, formato, ancho, alto, paginas_totales, paginas_preliminares, paginas_finales, lomo, forro, solapa, papel_forro_1, gramaje_forro_1, tinta_forro, acabado_forro, suaje_forro, grabado_forro, foliacion, papel_guardas_1, tinta_guardas, num_paginas_interior_1, papel_forro_2, gramaje_forro_2, papel_guardas_2, papel_interior_1_1, papel_interior_1_2, gramaje_interior_1_1, gramaje_interior_1_2, tinta_interior_1, acabados_interior_1, suaje_interior_1, grabado_interior_1, num_paginas_interior_2, papel_interior_2_1, papel_interior_2_2, gramaje_interior_2_1, gramaje_interior_2_2, tinta_interior_2, acabados_interior_2, suaje_interior_2, grabado_interior_2, paginas_desplegables, encartes, pop_ups, disco_compacto, audiocinta, videocinta, otras_caracteristicas_especiales, observaciones) FROM stdin;
1112	titulo	Título Original		Indice del título	Tepehúan	172	Edición	1987	6	Reseña	ISBN	Páginas con folio	Alemania	Ciudad	Reconocimiento para el libro	Reconocimiento para el autor	Reconocimiento para el ilustrador	1pre	Texto literario	El cuerpo	997	100	3	10	2021-03-11	1	1	horizontal	50	99	100	100	1000	1000	A caballo con 2 grapas	Si	Couché o similares	50	4x3	Barniz / Máquina / Brillante	Si	Si	Si	Bond o similares	5x1	50	Mate	50	Brillante	Couché o similares	Mate	100	Gramos	5x2	Barniz / Barniz UV / Brillante	Si	Si	1400	Couché o similares	Mate	50	Gramos	5x2	Barniz / Barniz UV / Mate	Si	Si	2	3	Más de 9	2	3	3	Otras características especiales	Observaciones
\.


--
-- TOC entry 3070 (class 0 OID 16493)
-- Dependencies: 218
...
298	bilingue_primaria_secundaria	4pri	BA	5	0	primaria_secundaria
299	bilingue_preescolar_primaria	1pre	BA	5	3	preescolar_primaria
300	bilingue_preescolar_primaria	2pre	BA	5	3	preescolar_primaria
301	bilingue_preescolar_primaria	3pre	BA	5	3	preescolar_primaria
302	bilingue_preescolar_primaria	1pri	BA	5	3	preescolar_primaria
303	bilingue_preescolar_primaria	2pri	BA	5	3	preescolar_primaria
304	bilingue_preescolar_primaria	3pri	BA	5	3	preescolar_primaria
\.


--
-- TOC entry 3072 (class 0 OID 16498)
-- Dependencies: 220
...
1720	4pri	BA	2	2	narrativa contemporánea: universal, latinoamericana y mexicana	primaria_secundaria	66
1721	primaria	BE	5	1	la naturaleza	preescolar_primaria	1
1722	5pri	BA	3	2	narrativa contemporánea: universal, latinoamericana y mexicana	primaria_secundaria	66
1723	preescolar	BE	5	3	enciclopedias, atlas y almanaques	preescolar_primaria	11
1724	preescolar	BE	5	3	los juegos, actividades y experimentos	preescolar_primaria	9
1725	primaria	BE	5	3	enciclopedias, atlas y almanaques	primaria_secundaria	59
1726	preescolar	BE	5	3	las palabras	preescolar_primaria	10
1727	preescolar	BE	5	3	las artes y los oficios	preescolar_primaria	8
1728	preescolar	BE	5	3	los lugares, la tierra y el espacio	preescolar_primaria	7
1729	preescolar	BE	5	3	la naturaleza	preescolar_primaria	1
1730	preescolar	BE	5	3	el cuerpo	preescolar_primaria	2
1731	preescolar	BE	5	3	las historias del pasado	preescolar_primaria	6
1732	preescolar	BE	5	3	las personas	preescolar_primaria	5
1733	preescolar	BE	5	3	los números y las formas	preescolar_primaria	3
1734	preescolar	BE	5	3	los objetos y su funcionamiento	preescolar_primaria	4
1735	1pri	BA	5	0	el cuerpo	preescolar_primaria	2
1736	1pre	BA	5	3	la naturaleza	preescolar_primaria	1
1737	2pre	BA	5	3	la naturaleza	preescolar_primaria	1
1738	1pri	BA	5	3	la naturaleza	preescolar_primaria	1
1739	2pri	BA	5	3	la naturaleza	preescolar_primaria	1
1740	3pri	BA	5	3	la naturaleza	preescolar_primaria	1
1741	3pre	BA	5	3	la naturaleza	preescolar_primaria	1
1742	1pre	BA	5	3	el cuerpo	preescolar_primaria	2
1743	2pre	BA	5	3	el cuerpo	preescolar_primaria	2
1744	3pre	BA	5	3	el cuerpo	preescolar_primaria	2
1745	2pri	BA	5	3	el cuerpo	preescolar_primaria	2
1746	3pri	BA	5	3	el cuerpo	preescolar_primaria	2
1747	1pre	BA	5	3	enciclopedias, atlas y almanaques	preescolar_primaria	11
1748	2pre	BA	5	3	enciclopedias, atlas y almanaques	preescolar_primaria	11
1749	3pre	BA	5	3	enciclopedias, atlas y almanaques	preescolar_primaria	11
1750	1pri	BA	5	3	enciclopedias, atlas y almanaques	preescolar_primaria	11
1751	2pri	BA	5	3	enciclopedias, atlas y almanaques	preescolar_primaria	11
1752	3pri	BA	5	3	enciclopedias, atlas y almanaques	preescolar_primaria	11
1753	4pri	BA	5	3	enciclopedias, atlas y almanaques	primaria_secundaria	59
1754	5pri	BA	5	3	enciclopedias, atlas y almanaques	primaria_secundaria	59
1755	6pri	BA	5	3	enciclopedias, atlas y almanaques	primaria_secundaria	59
1756	secundaria	BE	5	1	ciencias físico-químicas	primaria_secundaria	48
1757	primaria	BE	2	2	ciencias físico-químicas	primaria_secundaria	48
1758	preescolar	BE	1	0	cuentos de aventura y de viajes	preescolar_primaria	12
1759	preescolar	BE	1	0	cuentos de humor	preescolar_primaria	13
1760	primaria	BE	2	1	narrativa contemporánea: universal, latinoamericana y mexicana	primaria_secundaria	66
1761	secundaria	BE	5	3	narrativa contemporánea: universal, latinoamericana y mexicana	primaria_secundaria	66
\.


--
-- TOC entry 3074 (class 0 OID 16503)
-- Dependencies: 222
...
SELECT pg_catalog.setval('public.edi_sellos_sel_id_seq', 173, true);
...
SELECT pg_catalog.setval('public.editoriales_id_seq', 1112, true);
...
SELECT pg_catalog.setval('public.historial_actividades_id_seq', 12, true);
...
SELECT pg_catalog.setval('public.id_historial_seq', 490, true);


--
-- TOC entry 3102 (class 0 OID 0)
-- Dependencies: 214
-- Name: lib_autores_aut_id_seq1; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.lib_autores_aut_id_seq1', 15, true);
...
SELECT pg_catalog.setval('public."seleccionBilingue_id_seq"', 304, true);
...
SELECT pg_catalog.setval('public."seleccionMonolingue_id_seq"', 1761, true);
...
--
-- TOC entry 2873 (class 2606 OID 19539)
...
--
-- TOC entry 2889 (class 2606 OID 19541)
...
--
-- TOC entry 2875 (class 2606 OID 19543)
-- Name: cat_estados key_est_id; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2871 (class 2606 OID 19545)
...
--
-- TOC entry 2891 (class 2606 OID 19547)
...
--
-- TOC entry 2877 (class 2606 OID 19549)
...
--
-- TOC entry 2883 (class 2606 OID 19551)
...
--
-- TOC entry 2881 (class 2606 OID 19553)
-- Name: cat_paises key_pai_id; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2914 (class 2606 OID 19555)
...
--
-- TOC entry 2895 (class 2606 OID 19557)
-- Name: lib_autores lib_autores_pkey1; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lib_autores
    ADD CONSTRAINT lib_autores_pkey1 PRIMARY KEY (aut_id);


--
-- TOC entry 2899 (class 2606 OID 19559)
...
--
-- TOC entry 2879 (class 2606 OID 19561)
-- Name: cat_municipios mun_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2893 (class 2606 OID 19563)
...
--
-- TOC entry 2901 (class 2606 OID 19565)
-- Name: libros pk_id_libros; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.libros
    ADD CONSTRAINT pk_id_libros PRIMARY KEY (id);


--
-- TOC entry 2885 (class 2606 OID 19567)
...
--
-- TOC entry 2903 (class 2606 OID 19569)
...
--
-- TOC entry 2907 (class 2606 OID 19571)
...
--
-- TOC entry 2911 (class 2606 OID 19573)
...
--
-- TOC entry 2909 (class 2606 OID 19575)
...
--
-- TOC entry 2897 (class 2606 OID 19577)
-- Name: lib_autores unique_lib_autor; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lib_autores
    ADD CONSTRAINT unique_lib_autor UNIQUE (aut_nombre);


--
-- TOC entry 2905 (class 2606 OID 19579)
...
--
-- TOC entry 2887 (class 2606 OID 19581)
...
--
-- TOC entry 2916 (class 2606 OID 19583)
...
--
-- TOC entry 2912 (class 1259 OID 19584)
...
--
-- TOC entry 2920 (class 2606 OID 19585)
...
--
-- TOC entry 2922 (class 2606 OID 19590)
...
--
-- TOC entry 2924 (class 2606 OID 19595)
...
--
-- TOC entry 2919 (class 2606 OID 19600)
...
--
-- TOC entry 2917 (class 2606 OID 19605)
...
--
-- TOC entry 2923 (class 2606 OID 19610)
...
--
-- TOC entry 2918 (class 2606 OID 19615)
...
--
-- TOC entry 2921 (class 2606 OID 19620)
...
--
-- TOC entry 2925 (class 2606 OID 19625)
...
--
-- TOC entry 2926 (class 2606 OID 19630)
...
-- Completed on 2021-03-11 05:19:48 CST
