...
-- Started on 2021-02-19 02:57:34 CST
...
--
-- TOC entry 222 (class 1259 OID 444596)
...
--
-- TOC entry 221 (class 1259 OID 444594)
...
--
-- TOC entry 224 (class 1259 OID 444841)
...
--
-- TOC entry 223 (class 1259 OID 444839)
...
ALTER SEQUENCE public.libros_lib_id_seq OWNED BY public.libros.id;
...
--
-- TOC entry 2858 (class 2604 OID 444599)
...
--
-- TOC entry 2859 (class 2604 OID 444844)
...
ALTER TABLE ONLY public.libros ALTER COLUMN id SET DEFAULT nextval('public.libros_lib_id_seq'::regclass);
...
--
-- TOC entry 3038 (class 0 OID 16495)
-- Dependencies: 196
...
--
-- TOC entry 3056 (class 0 OID 441645)
-- Dependencies: 214
...
--
-- TOC entry 3059 (class 0 OID 441882)
-- Dependencies: 217
...
--
-- TOC entry 3039 (class 0 OID 16499)
-- Dependencies: 197
...
--
-- TOC entry 3060 (class 0 OID 441922)
-- Dependencies: 218
...
--
-- TOC entry 3058 (class 0 OID 441775)
-- Dependencies: 216
...
--
-- TOC entry 3040 (class 0 OID 16505)
-- Dependencies: 198
...
--
-- TOC entry 3055 (class 0 OID 433059)
-- Dependencies: 213
...
--
-- TOC entry 3053 (class 0 OID 433020)
-- Dependencies: 211
...
--
-- TOC entry 3041 (class 0 OID 16511)
-- Dependencies: 199
...
--
-- TOC entry 3064 (class 0 OID 444596)
-- Dependencies: 222
...
--
-- TOC entry 3066 (class 0 OID 444841)
-- Dependencies: 224
...
--
-- TOC entry 3044 (class 0 OID 16523)
-- Dependencies: 202
...
--
-- TOC entry 3062 (class 0 OID 444412)
-- Dependencies: 220
-- Data for Name: libros; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.libros (id, edi_id, titulo, titulo_original, material, indice_titulo, material_lengua_indigena, sello_id, edicion, anio, tiraje, resenia, isbn, paginas_con_folio, pais, ciudad, reconocimiento_libro, reconocimiento_autor, reconocimiento_ilustrador, nivel, genero, categoria, precio_publico, disponibilidad, numero_tipo_papel) FROM stdin;
1	1111	Título libro					168	Edición del título	1985	50	asdf	123456	55	Afganistán	Ciudad	afsd	af	asf	1pre	Texto literario	El cuerpo	50	10	1
2	1111	Título libro 2					169	Edición del título	1958	52	asdf	123456	55	Bélgica	Ciudad	asdf	asfd	asfd	1pre	Texto literario	El cuerpo	100	10	5
\.


--
-- TOC entry 3051 (class 0 OID 16712)
-- Dependencies: 209
...
--
-- TOC entry 3049 (class 0 OID 16679)
-- Dependencies: 207
...
--
-- TOC entry 3047 (class 0 OID 16664)
-- Dependencies: 205
...
--
-- TOC entry 3045 (class 0 OID 16529)
-- Dependencies: 203
...
SELECT pg_catalog.setval('public.edi_sellos_sel_id_seq', 170, true);
...
SELECT pg_catalog.setval('public.editoriales_id_seq', 1111, true);
...
SELECT pg_catalog.setval('public.id_historial_seq', 476, true);
...
SELECT pg_catalog.setval('public.lib_autores_aut_id_seq1', 14, true);
...
SELECT pg_catalog.setval('public.libros_lib_id_seq', 2, true);
...
--
-- TOC entry 2904 (class 2606 OID 444849)
...
--
-- TOC entry 2902 (class 2606 OID 444604)
...
--
-- TOC entry 2906 (class 2606 OID 444851)
...
--
-- TOC entry 2914 (class 2606 OID 441755)
...
--
-- TOC entry 2916 (class 2606 OID 444605)
...
--
-- TOC entry 2913 (class 2606 OID 444646)
...
--
-- TOC entry 2915 (class 2606 OID 441731)
...
--
-- TOC entry 2907 (class 2606 OID 16631)
...
--
-- TOC entry 2910 (class 2606 OID 16636)
...
--
-- TOC entry 2908 (class 2606 OID 16641)
...
--
-- TOC entry 2909 (class 2606 OID 441745)
...
--
-- TOC entry 2912 (class 2606 OID 16656)
...
-- Completed on 2021-02-19 02:57:35 CST
