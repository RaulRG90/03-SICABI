...
$("#frmAcreditarEditorial").on("submit",function(a){a.preventDefault();a.stopPropagation();!1===this.checkValidity()?this.classList.add("was-validated"):(a=extraerDatos(),$.ajax({async:!0,type:"POST",dataType:"json",contentType:"application/x-www-form-urlencoded; charset=UTF-8",url:api_acreditar_editorial,data:a,success:function(a){a.error?swal("Error!",a.error.message,"error"):(swal("Exito!",a.message,"success"),$("#frmAcreditarEditorial").trigger("reset"),limpiarSellos(),$("#tbl_editoriales").DataTable().ajax.reload(null,
!1))},error:function(a){swal("Error!","Error desconocido, comuniquese con el administrador","error")}}))});
