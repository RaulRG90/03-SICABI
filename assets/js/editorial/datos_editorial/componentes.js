var form_datos_editorial={
    'data':'',
    'id_form':'form_datos_editorial',
    'desalertar':function(){
    ...
    'header_create':function(){
        ...
        let p=$('<p>',{'class':'alert text-center'});
    ...
    'form_create':function(){
        ...
        //Pais
        atributos_control={'disabled':'disabled','required':'required'};
        let pais=this.data.editorial.data[0].edi_pais;
        pais=this.group_input_create('pais',pais,'País',[atributos_control]);
        
        //Entidad Federativa
        atributos_control={'disabled':'disabled','required':'required'};
        let entidad_federativa=this.data.editorial.data[0].edi_entidad_federativa;
    ...
    'render':function(){
        ...
        let contenedor=$('#seccion_frm_editorial');
