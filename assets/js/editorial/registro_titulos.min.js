...
"1"===datos.editorial_estatus?($("#cabecera_principal").append(componente_cabecera.render(base_url,datos.editorial_folio)),$("#section_btn_registrar_titulo").append(componente_btn_registrar_titulo.render()),g(datos.editorial_folio)):(componente_form_activacion_editorial.data=datos.activacion,componente_form_activacion_editorial.alertar("Antes de iniciar con el registro de titulos debe validar los siguientes datos"),componente_form_activacion_editorial.render());$("#btn_registrar_titulo").on("click",
b=>{0===$("#seccion_frm_registro").children().length&&($("#section_titulos_registrados").children().hide(),componente_form_registro_titulos.data=datos.registro,$("#seccion_frm_registro").append(componente_form_registro_titulos.render()),componente_form_autor.data=datos.registro,$("#modales").append(componente_form_autor.render()),$("#eliminar_autor").on("click",a=>{let b=$(a.target).attr("autor");a={aut_nombre:b};"false"!=b?$.ajax({async:!0,type:"POST",dataType:"JSON",contentType:"application/x-www-form-urlencoded; charset=UTF-8",
...
numero_tipo_papel:$("#form_registro_tipo_papel").val(),formato:$("#form_registro_formato").val(),ancho:$("#form_registro_ancho").val(),alto:$("#form_registro_alto").val(),paginas_totales:$("#form_registro_paginas_totales").val(),paginas_preliminares:$("#form_registro_paginas_preliminares").val(),paginas_finales:$("#form_registro_paginas_finales").val(),lomo:$("#form_registro_lomo").val(),forro:$("#form_registro_forro").val(),solapa:$("#form_registro_forro_solapa").val(),papel_forro_1:$("#form_registro_papel_forro1").val(),
papel_forro_2:$("#form_registro_papel_forro2").val(),gramaje_forro_1:$("#form_registro_gramaje_forro1").val(),gramaje_forro_2:$("#form_registro_gramaje_forro1").val(),tinta_forro:$("#form_registro_tintas_forro").val(),acabado_forro:$("#form_registro_acabado_forro").val(),suaje_forro:$("#form_registro_suaje").val(),grabado_forro:$("#form_registro_grabado").val(),foliacion:$("#form_registro_foliacion").val(),papel_guardas_1:$("#form_registro_papel_guardas").val(),papel_guardas_2:$("#form_registro_papel_guardas2").val(),
tinta_guardas:$("#form_registro_tintas_guarda").val(),num_paginas_interior_1:$("#form_registro_num_paginas").val(),papel_interior_1_1:$("#form_registro_papel_interior_1").val(),papel_interior_1_2:$("#form_registro_papel_interior_1_2").val(),gramaje_interior_1_1:$("#form_registro_gramaje_interior_1").val(),gramaje_interior_1_2:$("#form_registro_gramaje_interior_1_2").val(),tinta_interior_1:$("#form_registro_tinta_interior_1").val(),acabados_interior_1:$("#form_registro_acabados_interior_1").val(),
suaje_interior_1:$("#form_registro_suaje_interior_1").val(),grabado_interior_1:$("#form_registro_grabado_interior_1").val(),num_paginas_interior_2:$("#form_registro_num_paginas_interior_2").val(),papel_interior_2_1:$("#form_registro_papel_interior_2").val(),papel_interior_2_2:$("#form_registro_papel_interior_2_2").val(),gramaje_interior_2_1:$("#form_registro_gramaje_interior_2").val(),gramaje_interior_2_2:$("#form_registro_gramaje_interior_2_2").val(),tinta_interior_2:$("#form_registro_tinta_interior_2").val(),
acabados_interior_2:$("#form_registro_acabados_interior_2").val(),suaje_interior_2:$("#form_registro_suaje_interior_2").val(),grabado_interior_2:$("#form_registro_grabado_interior_2").val(),paginas_desplegables:$("#form_registro_paginas_desplegables").val(),encartes:$("#form_registro_encartes").val(),pop_ups:$("#form_registro_pop_ups").val(),disco_compacto:$("#form_registro_disco_compacto").val(),audiocinta:$("#form_registro_audiocinta").val(),videocinta:$("#form_registro_videocinta").val(),otras_caracteristicas_especiales:$("#form_registro_otras_caracteristicas_especiales").val(),
observaciones:$("#form_registro_observaciones").val()},$("#form_registro_check_antologia").prop("checked")&&(a.antologia=1),$("#form_registro_check_ilustrado").prop("checked")&&(a.ilustrado=1),$.ajax({async:!0,type:"POST",dataType:"JSON",contentType:"application/x-www-form-urlencoded; charset=UTF-8",url:api_registrar_titulo,data:a,success:function(a){a.error?swal("Error!",a.error.message,"error"):(swal("Correcto!",a.message,"success"),$("#section_titulos_registrados").children().show(),$("#seccion_frm_registro").children().remove(),
a=$("#tbl_titulos_registrados").DataTable(),console.log(a),a.ajax.reload(null,!1))},error:function(a){swal("Error!","Error desconocido, comuniquese con el administrador","error")}}))}),$("#btn_cancelar_registro").on("click",a=>{a.preventDefault();$("#section_titulos_registrados").children().show();$("#seccion_frm_registro").children().remove()}),$("button.collapsed").off("click"),$("button.collapsed").on("click",a=>{a.preventDefault();a.stopPropagation();a=$(a.target).attr("aria-controls");let b=
$(`#${a}`).attr("class");$("div.collapse").removeClass("show");"collapse"==b&&($(`div#${a}`).addClass("show"),console.log(b),console.log($(`div#${a}`)))}))});$(document).off("submit","#form_activacion_editorial");$(document).on("submit","#form_activacion_editorial",function(b){b.preventDefault();b.stopPropagation();b=h();$.ajax({url:api_activar_editorial,type:"POST",dataType:"JSON",contentType:"application/x-www-form-urlencoded; charset=UTF-8",data:b,success:function(a){"Editorial Activada"===a.message?
(swal("Exito!",a.message,"success"),location.reload()):swal("Error!",a.error.message,"error")},error:function(a){console.log(a)}})});$(document).on("focusout","#form_activacion_editorial_pais",b=>{b=JSON.parse(sessionStorage.getItem("mostrar_entidades"));if("M\u00e9xico"===$("#form_activacion_editorial_pais").val()){if(null===b||!1===b){b=$("#form_activacion_editorial_entidad_federativa");var a=$(b).parent();let c=$("<select>",{"class":"custom-select",id:"form_activacion_editorial_entidad_federativa"});
JSON.parse(sessionStorage.getItem("datos_activacion"));console.log(datos);datos.activacion.estados.data.forEach(a=>{let b=$("<option>",{value:a.est_estado});$(b).text(a.est_estado);$(c).append(b)});$(a).append($(c));$(b).remove();sessionStorage.setItem("mostrar_entidades","true")}}else if(null!==b||!0===b){b=$("#form_activacion_editorial_entidad_federativa");a=$("#form_activacion_editorial_del_mun");let c=$(b).parent(),d=$(a).parent(),f=$("<input>",{type:"text","class":"form-control",id:"form_activacion_editorial_entidad_federativa"}),
k=$("<input>",{type:"text","class":"form-control",id:"form_activacion_editorial_del_mun"});$(c).append($(f));$(d).append($(k));$(b).remove();$(a).remove();sessionStorage.setItem("mostrar_entidades","false")}});$(document).on("focusout","#form_activacion_editorial_entidad_federativa",b=>{b=$("#form_activacion_editorial_del_mun");let a=$(b).parent(),c=$("<select>",{"class":"custom-select",id:"form_activacion_editorial_del_mun"});JSON.parse(sessionStorage.getItem("datos_activacion"));let d=datos.activacion.estados.data.filter(a=>
a.est_estado===$("#form_activacion_editorial_entidad_federativa").val());$(c).children().remove();datos.activacion.municipios.data.forEach(a=>{if(d[0].est_id===a.est_id){let b=$("<option>",{value:a.mun_municipio});$(b).text(a.mun_municipio);$(c).append(b)}});$(a).append($(c));$(b).remove()})});