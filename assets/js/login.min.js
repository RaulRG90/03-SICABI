...
"aprobado"===a.estatus?(swal(a.mensaje,"\u00a1Acceso Correcto!","success"),location.href=base_url+"/"+a.permiso):swal("\u00a1Error!",a.mensaje,"error")},error:function(a){console.log(a);swal("\u00a1Error Desconocido!","Comuniquese con el administrador","error")}})}})});