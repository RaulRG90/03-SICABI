var base_url=window.location.protocol+"//"+window.location.host,componentes=base_url+"/assets/js/login/componentes.min.js",componente_login,api_leer_nombre_sistema=base_url+"/login/leer_nombre_sistema",api_iniciar_sesion=base_url+"/login/iniciar_sesion",datos={};
