var componentes=base_url+"assets/js/administrador/convocatoria/clasificacion_indicativa/componentes.min.js",componente_cabecera,componente_btn_bilioteca,componente_acorden,componente_tab,componente_selecciones,componente_frm_agregar_seleccion,componente_frm_editar_seleccion,api_leer_seleccion_monolingue=base_url+"administrador/convocatoria/leer_seleccion_monolingue",api_leer_seleccion_bilingue=base_url+"administrador/convocatoria/leer_seleccion_bilingue",api_guardar_selecciones=base_url+"administrador/convocatoria/guardar_seleccion",
api_leer_tipo_biblioteca=base_url+"administrador/convocatoria/leer_tipo_biblioteca",api_vista_previa=base_url+"administrador/convocatoria/vista_previa",api_leer_textos=base_url+"administrador/convocatoria/leer_textos",leer_preescolar_primaria_informativos=base_url+"administrador/convocatoria/leer_categorias/de preescolar a tercero de primaria/textos informativos",leer_preescolar_primaria_literarios=base_url+"administrador/convocatoria/leer_categorias/de preescolar a tercero de primaria/textos literarios",
leer_primaria_secundaria_informativos=base_url+"administrador/convocatoria/leer_categorias/de cuarto de primaria a tercero de secundaria/textos informativos",leer_primaria_secundaria_literarios=base_url+"administrador/convocatoria/leer_categorias/de cuarto de primaria a tercero de secundaria/textos literarios",datos={};
...
$($("tr[id_seleccion="+$("#btn_actualizar_seleccion").attr("id_seleccion")+"]").children()[0]).text(f),$($("tr[id_seleccion="+$("#btn_actualizar_seleccion").attr("id_seleccion")+"]").children()[1]).text(g),$($("tr[id_seleccion="+$("#btn_actualizar_seleccion").attr("id_seleccion")+"]").children()[2]).text(h),$("#btn_guardar_cambios").removeAttr("disabled"),swal("Exito!","La selecci\u00f3n se actualiz\u00f3 correctamente","success"))});$(document).off("change","#edit_txt_preseleccion");$(document).on("change",
"#edit_txt_preseleccion",function(){let a=$(this).val();$("#edit_txt_seleccion").attr("max",a)});$(document).off("click",".btn_eliminar");$(document).on("click",".btn_eliminar",function(){let a=$(this).attr("id_seleccion"),b=$(this).attr("tipo"),c=$("tr[id_seleccion="+a+"]"),d=JSON.parse(sessionStorage.getItem(b));console.log(d);console.log(a);d.forEach(function(b,c){parseInt(a)===parseInt(b.id)&&d.splice(c,1)});sessionStorage.setItem(b,JSON.stringify(d));$(c).remove();$("#btn_guardar_cambios").removeAttr("disabled")})});