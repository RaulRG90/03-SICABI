...
<div id="mdlAcreditarEditorial">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header text-center">
                <h3 class="modal-title">Acreditación de Editoriales - Nuevo registro</h3>
            </div>

            <!-- Modal body -->
            <div class="modal-body">
                <form id="frmAcreditarEditorial" class="was-validated">

                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text">Razón Social/Titular:</span>
                        </div>
                        <input id="txt_razon_social" type="text" class="form-control" placeholder="Razón social de la editorial" required="required" pattern="[a-zA-Z,áéíóúÁÉÍÓÚÑñ&.' ]+" >
                    ...
                    <fieldset>
                        ...
                        <div id="sello_editorial_1" class="input-group mb-3">
                            <div class="input-group-prepend">
                    ...
                    <fieldset>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="txt_nombre_director_general" type="text" class="form-control" placeholder="Nombre del director general"  required="required" pattern="[a-zA-Z,áéíóúÁÉÍÓÚÑñ' ]+">
                            <div class="valid-feedback">OK.</div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="txt_email_director_general" type="email" class="form-control" placeholder="Correo electronico de contacto" required="required">
                            <div class="valid-feedback">OK.</div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="txt_celular_director_general" type="tel" class="form-control" placeholder="Celular" required="required" />
                            <div class="valid-feedback">OK.</div>
                    ...
                    <fieldset>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="txt_nombre_representante_editorial" type="text" class="form-control" placeholder="Nombre del representante editorial" required="required" pattern="[a-zA-Z,áéíóúÁÉÍÓÚÑñ' ]+">
                            <div class="valid-feedback">OK.</div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="txt_cargo_representante_editorial" type="text" class="form-control" placeholder="Cargo del representante editorial"  required="required" pattern="[a-zA-Z,áéíóúÁÉÍÓÚÑñ' ]+">
                            <div class="valid-feedback">OK.</div>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="txt_email_representante_editorial" type="email" class="form-control" placeholder="Correo electrónico de contacto" required="required">
                            <div class="valid-feedback">OK.</div>
                            <div class="invalid-feedback">El correo electrónico no puede ir vacio.</div>
                        </div>
                    </fieldset>
