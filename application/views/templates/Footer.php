...
<script type="text/javascript" src="<?php echo base_url('assets/js/jquery.min.js'); ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo base_url('assets/js/sicafun.js'); ?>"></script>
    <script type="text/javascript">
      $(document).ready(function() {
          ...
          var res = [];
          res = JSON.parse('<?php echo $urls;?>');
          var divc = document.getElementById("sub");
          datos = "";
          if(res.length){
            res.forEach(function(valor, indice, array){
              datos += "<li><a class='waves-effect arrow-r' href='<?php echo base_url();?>"+array[indice]['url_sub'];
