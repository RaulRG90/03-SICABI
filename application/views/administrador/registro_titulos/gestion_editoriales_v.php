...
<!-- CSS Módulo -->
<link rel="stylesheet" href="<?=base_url('assets/css/administrador/registro_titulos/gestion_usuarios.min.css')?>">

<div id="contenedor_principal" class="container-fluid">
    <header id="cabecera_principal"></header>
    <section id="tablas_perfil"></section>
...
<script type="text/javascript" src="<?=base_url('assets/js/administrador/registro_titulos/gestion_editoriales.min.js')?>"></script>