<!--Tabla de categorías textos informativos contenido 1-->
<table class="table table-hover">
    ...
    <tbody>
        ...
        <!--Crear categorías-->
        <?php $informativos=$tablasClasificacion['de preescolar a tercero de primaria']['categorias']['textos informativos']; ?>
        <?php 
            asort($informativos);
