<!--Tabla de categorías textos literarios contenido 2-->
<table class="table table-hover">
    ...
    <tbody>
        ...
        <!--Crear categorías-->
        <?php $informativos=$tablasClasificacion['de cuarto de primaria a tercero de secundaria']['categorias']['textos literarios']; ?>
        <?php 
            asort($informativos);
            $clasificacion=$tablasClasificacion['de cuarto de primaria a tercero de secundaria']['clasificacion'];
